...
// export class GasDryer implements IDirectUsageBasedCharge, IProportionUse {
...
//     id: string = Sinks.gas.gasDryer;
//     public static displayName: string = 'Gas dryer';
//     public static purpose: Purpose = 'Other';
//     purpose: Purpose = GasDryer.purpose;
//     displayName: string = GasDryer.displayName;
// }
